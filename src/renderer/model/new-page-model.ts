...
import { newTextFileModel, newTextFileModelFromState } from "../pages/text-file-page/TextFilePage.model";
...
export async function newPageModel(filePath?: string): Promise<PageModel> {
    ...
    switch (ext) {
        case ".pdf": {
            const module = await import("../custom-editors/pdf-page/PdfPage");
