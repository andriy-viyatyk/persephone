...
export const ABOUT_ELEMENTS: readonly IAiElementDeclaration[] = [
    ...
    { name: "about-resources", purpose: "In the contents pane, show the repository, issues, boards, and MCP resources.", where: "guide contents pane, Resources section" },
    { name: "about-resource-repository", purpose: "In the contents pane, open the Persephone repository resource.", where: "guide contents pane, repository resource" },
    { name: "about-resource-issues", purpose: "In the contents pane, open the Persephone issues resource.", where: "guide contents pane, issues resource" },
    { name: "about-resource-boards", purpose: "In the contents pane, open the in-app Boards catalogue guide.", where: "guide contents pane, Boards resource" },
    { name: "about-resource-mcp-setup", purpose: "In the contents pane, open the in-app MCP setup guide.", where: "guide contents pane, MCP setup resource" },
