...
export const ABOUT_ELEMENTS: readonly IAiElementDeclaration[] = [
    { name: "about-root", purpose: "The complete About page containing the card and guide browser." },
    { name: "about-content", purpose: "The About card's product, version, runtime, update, and link content." },
    { name: "about-card", purpose: "The left About pane with Persephone identity, runtime information, update status, and external links." },
    { name: "about-check-updates", purpose: "Check whether a newer Persephone release is available." },
    { name: "about-github", purpose: "Open the Persephone GitHub repository." },
    { name: "about-report-issue", purpose: "Open the Persephone issue tracker to report a problem." },
    { name: "about-update-download", purpose: "Download the available Persephone update release." },
    { name: "about-update-whats-new", purpose: "Open the in-app What's New guide for the available update." },
    { name: "about-splitter", purpose: "Resize the left About card pane and the right guide pane." },
    { name: "about-guide-browser", purpose: "The right side of About containing either guide contents or the selected guide page." },
    { name: "about-whats-new", purpose: "In the contents pane, show the inline What's New release-note summary." },
    { name: "about-whats-new-open", purpose: "In the contents pane, open the complete What's New guide in the About pane." },
    { name: "about-resources", purpose: "In the contents pane, show the repository, issues, boards, and MCP resources." },
    { name: "about-resource-repository", purpose: "In the contents pane, open the Persephone repository resource." },
    { name: "about-resource-issues", purpose: "In the contents pane, open the Persephone issues resource." },
    { name: "about-resource-boards", purpose: "In the contents pane, open the in-app Boards catalogue guide." },
    { name: "about-resource-mcp-setup", purpose: "In the contents pane, open the in-app MCP setup guide." },
    { name: "about-show-agent-guides", purpose: "In the contents pane, include agent-audience guides in the contents tree." },
    { name: "about-guide-tree", purpose: "In the contents pane, browse the available guide pages and folders." },
    { name: "about-guide-page", purpose: "In guide state, host the right-pane view that replaces contents for the selected guide." },
    { name: "about-guide-breadcrumbs", purpose: "In guide state, show the current guide's navigable folder and page trail." },
    { name: "about-guide-back", purpose: "In guide state, return to the previous About guide location." },
    { name: "about-guide-open-in-tab", purpose: "In guide state, open the current guide as a normal Markdown tab without changing About's location." },
    { name: "about-guide-body", purpose: "In guide state, display the rendered Markdown body of the selected guide." },
];
