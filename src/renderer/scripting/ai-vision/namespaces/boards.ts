...
const BOARDS_MEMBERS: readonly IAiMember[] = [
    ...
    { name: "openBoard", kind: "method", signature: "openBoard(boardRoot: string, options?: { intent?: { id: string; version?: number; requestId: string; payload: unknown } })", summary: "Open an existing board in a new or reused tab, optionally delivering one in-memory capability request.", caution: "opens a visible page and may invoke board trust flow" },
