...
const MENU_BAR_ELEMENTS: readonly IAiElementDeclaration[] = [
    ...
    { name: "menubar-guide-for-page", purpose: "Opens the guide for the active page's editor, or the guide contents when it is unmapped.", where: "top action row of the left category column, right group, after User Guide and before Settings" },
    { name: "menubar-settings", purpose: "Opens the Settings page.", where: "top action row of the left category column, right end, immediately right of Guide for this page" },
