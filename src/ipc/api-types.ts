import { IEditorState, PageDragData, WindowPages } from "../shared/types";
import {
    CommonFolder,
    DownloadEntry,
...
export type EventApi = {
    ...
    [EventEndpoint.eMovePageIn]: EventObject<{ page: Partial<IEditorState>; targetPageId: string | undefined }>;
