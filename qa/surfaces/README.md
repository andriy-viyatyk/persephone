...
| [about-guide-browser.md](about-guide-browser.md) | The About page's two panes and the `about-view` facade: putting a guide on the user's screen | EPIC-093 (US-1372) |
...
| [events.md](events.md) | `events` — what changed since the agent last looked: the result block, the ring, the blocking `wait`, remote shape signals, and `ui.guide.step` | EPIC-099 (US-1397 to US-1400) |
