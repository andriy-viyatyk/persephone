...
- **Multiple Editors** - Grid view for JSON/CSV, Markdown preview, the bundled Excalidraw board, Rest Client, Video Player, and more (PDF viewing is available as an opt-in [board](./boards.md) install)
