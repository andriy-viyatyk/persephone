...
title: "app"
audience: user
summary: "The root application object and entry point to app functionality in scripts."
---
...
See [Scripting — Background Workers](../index.md#background-workers-apprunasync) for usage guide and examples.
