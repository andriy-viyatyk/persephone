---
title: "Agent Tools — reuse parameterized tools instead of re-writing scripts"
audience: agent
summary: "Agent Tools registry reference: discovery and execution paths, the stdin JSON/result-marker contract, environment secrets, and self-repair."
---
