---
title: "Boards — build a custom board/editor for the user"
audience: agent
summary: "Boards authoring reference: board lifecycle, the execute channel, theme contract, local vendoring, and automation."
---
