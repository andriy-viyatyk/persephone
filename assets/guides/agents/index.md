---
title: "Persephone Overview — start here"
audience: agent
summary: "Persephone's mental model: windows, pages, editors, boards, and the call-based object model. Start here when the application is unfamiliar."
---
