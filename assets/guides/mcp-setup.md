...
audience: user
summary: "Enable and connect to Persephone's built-in Model Context Protocol server."
---
...
the user has answered. See the [ui API reference](./scripting/api/ui-log.md#log-view-output) for all entry
types and dialog options.

### Advanced scripting

The `script.execute` call path gives AI access to the full [Scripting API](scripting/index.md):
