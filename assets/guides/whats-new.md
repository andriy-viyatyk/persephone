...
- **"Copy Board Path" context-menu item** — Right-clicking a board in the **Boards** Explorer panel, the **Boards** tab of the Tools & Editors sidebar, or an open board page tab now offers **Copy Board Path**, copying the board's folder path to the clipboard. See [Tabs and navigation — Tab Context Menu](./tabs-and-navigation.md#tab-context-menu) and [Boards — Managing boards](./boards.md#managing-boards).
