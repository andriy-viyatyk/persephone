...
+---------------------------------------------------------------------+
| [Open File] [New Window]          [About] [User Guide] [Settings]   |  top action row of the left category column; left and right groups, Settings immediately right of User Guide
