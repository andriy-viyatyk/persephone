...
└── GraphViewModel          # Force graph editing (composes GraphDataModel, GraphGroupModel, GraphSearchModel, GraphHighlightModel, ForceGraphRenderer, GraphVisibilityModel)
```
