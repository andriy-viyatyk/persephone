...
- MCP resources: focused guides (`assets/mcp-res-*.md`) exposed as `notepad://guides/ui-push`, `notepad://guides/pages`, `notepad://guides/scripting`, `notepad://guides/graph`, `notepad://guides/notebook`, `notepad://guides/todo`, `notepad://guides/links`, plus `notepad://guides/full` (concatenated). Server instructions provide immediate context on connection. Tool descriptions warn agents to read dedicated guides before using structured editors or dialogs.
