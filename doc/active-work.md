...
- **EPIC-025** — [Unified Component Library and Storybook Editor](epics/EPIC-025.md)
  ...
  - [ ] [US-501: RestClient editor — UIKit migration](tasks/US-501-rest-client-migration/README.md) *(Phase 4 — per-screen migration; plan ready for review; blocked on US-533 `Autocomplete` precursor; bundles two small UIKit extensions — Textarea width/flex props, Panel.dimmed — Concern F still needs user decision)*
  ...
  - [ ] [US-532: Legacy `components/{basic,form,layout,overlay}/` removal](tasks/US-532-legacy-components-removal/README.md) *(Phase 4 — epic close-out; placeholder; blocked on every per-screen migration + US-481 + US-530 + US-531; deletes the four legacy folders + barrel exports; final sweep before EPIC-025 close)*
