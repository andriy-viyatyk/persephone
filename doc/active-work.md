...
- **EPIC-025** — [Unified Component Library and Storybook Editor](epics/EPIC-025.md)
  ...
  - [ ] [US-501: RestClient editor — UIKit migration](tasks/US-501-rest-client-migration/README.md) *(Phase 4 — per-screen migration; plan ready for review; blocked on US-533 `Autocomplete` + US-534 primitive extensions; all concerns resolved)*
